...
class ScheduleViewModel(private val scheduleRepository: ScheduleRepository): ViewModel(), ScheduleContract.ViewModel {

    override val schedule: MutableLiveData<List<Lecture>> = MutableLiveData()
    override val lecture: MutableLiveData<Lecture> = MutableLiveData()
